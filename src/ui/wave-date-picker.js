...
class WaveDatePane extends HTMLElement {
    ...
    constructor() {
        ...
        <div class="date-pane" id="date-pane">
            <div class="date-head">
                <wave-button type="flat" class="prev">
                ...
                <wave-button type="flat" class="date-switch">
                    2019-08
                </wave-button>
                <wave-button type="flat" class="next">
...
if (!customElements.get('wave-date-pane')) {
    customElements.define('wave-date-pane', WaveDatePane);
}

class WaveDateRangePane extends HTMLElement {
    static get observedAttributes() { return ['min','max','type'] }
    ...
    constructor() {
        ...
        <wave-date-pane id="date-left" range="left"></wave-date-pane>
        <wave-date-pane id="date-right" range="right"></wave-date-pane>
        `
    }
...
if (!customElements.get('wave-date-range-pane')) {
    customElements.define('wave-date-range-pane', WaveDateRangePane);
}

export default class WaveDatePicker extends HTMLElement {
    ...
    constructor() {
        ...
        :host(:focus-within) wave-popover,:host(:hover) wave-popover{ 
            z-index: 2;
        }
        :host([disabled]){
            pointer-events:none;
        ...
        .pop-footer wave-button{
            font-size: inherit;
            margin-left: .8em;
        }
        </style>
        <wave-popover class="date-picker" id="popover" ${this.dir? "dir='"+this.dir+"'" : ""}>
            <wave-button id="select" ${this.disabled? "disabled" : ""}><span id="datetxt"></span><svg class="icon" viewBox="0 0 1024 1024"><path d="M880 184H712v-64c0-4.4-3.6-8-8-8h-56c-4.4 0-8 3.6-8 8v64H384v-64c0-4.4-3.6-8-8-8h-56c-4.4 0-8 3.6-8 8v64H144c-17.7 0-32 14.3-32 32v664c0 17.7 14.3 32 32 32h736c17.7 0 32-14.3 32-32V216c0-17.7-14.3-32-32-32z m-40 656H184V460h656v380zM184 392V256h128v48c0 4.4 3.6 8 8 8h56c4.4 0 8-3.6 8-8v-48h256v48c0 4.4 3.6 8 8 8h56c4.4 0 8-3.6 8-8v-48h128v136H184z" p-id="8054"></path></svg></wave-button>
            <wave-popcon id="popcon" class="date-pane">
                <div class="pop-footer">
                    <wave-button autoclose>取消</wave-button>
                    <wave-button type="primary" id="btn-submit" autoclose>确认</wave-button>
                </div>
            </wave-popcon>
        </wave-popover>
        `
    ...
    connectedCallback() {
        ...
        this.select.addEventListener('click',()=>{
            if(!this.datePane){
                if(this.range){
                    this.datePane = new WaveDateRangePane();
                }else{
                    this.datePane = new WaveDatePane();
                }
...
if (!customElements.get('wave-date-picker')) {
    customElements.define('wave-date-picker', WaveDatePicker);
}
