...
export default class WaveRate extends HTMLElement {
    ...
    constructor() {
        ...
        .star-item:hover wave-icon{
            transform:scale(1.2)
        }
        :host(:not([disabled]):hover) wave-tips.star-item{
            color:inherit;
        }
        :host(:not([disabled])) wave-tips.star-item:hover,
        :host(:not([disabled])) wave-tips.star-item:hover~.star-item{
           color:var(--themeColor,#42b983);
        }
        ...
        <wave-tips class="star-item" tips=${this.tips[4]}>
            <label for="item05">
                <wave-icon name=${this.icon}></wave-icon>
            </label>
        </wave-tips>
        <input type="radio" name="item" id="item04" value="4" />
        <wave-tips class="star-item" tips=${this.tips[3]}>
            <label for="item04">
                <wave-icon name=${this.icon}></wave-icon>
            </label>
        </wave-tips>
        <input type="radio" name="item" id="item03" value="3" />
        <wave-tips class="star-item" tips=${this.tips[2]}>
            <label for="item03">
                <wave-icon name=${this.icon}></wave-icon>
            </label>
        </wave-tips>
        <input type="radio" name="item" id="item02" value="2" />
        <wave-tips class="star-item" tips=${this.tips[1]}>
            <label for="item02">
                <wave-icon name=${this.icon}></wave-icon>
            </label>
        </wave-tips>
        <input type="radio" name="item" id="item01" value="1" />
        <wave-tips class="star-item" tips=${this.tips[0]}>
            <label for="item01">
                <wave-icon name=${this.icon}></wave-icon>
            </label>
        </wave-tips>
...
if(!customElements.get('wave-rate')){
    customElements.define('wave-rate', WaveRate);
}
