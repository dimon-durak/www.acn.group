export default class WaveForm extends HTMLElement {
    ...
    constructor() {
        ...
        :host(:not([type=full])) ::slotted(:not(wave-form-item)){
...
if(!customElements.get('wave-form')){
    customElements.define('wave-form', WaveForm);
}


class WaveFormItem extends HTMLElement {
...
if(!customElements.get('wave-form-item')){
    customElements.define('wave-form-item', WaveFormItem);
}
