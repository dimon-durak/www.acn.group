...
class WaveMessage extends HTMLElement {
    ...
    constructor() {
        ...
        :host([show][type="loading"]) wave-loading{
            display:block;
        }
        :host([show][type="loading"]) wave-icon{
            display:none;
        }
        :host wave-icon{
        ...
        <div class="message">
            <wave-icon id="message-type" class="message-type" size="16"></wave-icon>
...
if(!customElements.get('wave-message')){
    customElements.define('wave-message', WaveMessage);
}
