...
export default class WaveSlider extends HTMLElement {
    ...
    constructor() {
        ...
        :host([vertical]) wave-tips::before,:host([vertical]) wave-tips::after{
...
if(!customElements.get('wave-slider')){
    customElements.define('wave-slider', WaveSlider);
}
