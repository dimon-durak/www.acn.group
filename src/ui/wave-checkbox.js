import './wave-tips.js';
export default class WaveCheckbox extends HTMLElement {
    ...
    constructor() {
        ...
        */
        ...
        <wave-tips id="tip" type="error" dir="topleft">
...
if(!customElements.get('wave-checkbox')){
    customElements.define('wave-checkbox', WaveCheckbox);
}


class WaveCheckboxGroup extends HTMLElement {
    ...
    constructor() {
        ...
        :host(:focus-within) wave-tips,:host(:hover) wave-tips{
            z-index:2;
        }
        :host([disabled]){ 
            pointer-events: none; 
        ...
        :host([disabled]) ::slotted(wave-checkbox){
            pointer-events: none;
            opacity:.6;
        }
        ::slotted(wave-checkbox){
        ...
        <wave-tips id="tip" ${this.disabled?"tabindex='-1'":""} type="error"><slot></slot></wave-tips>
        `
    }
    ...
    get value() {
        return [...this.querySelectorAll('wave-checkbox[checked]')].map(el=>el.value);
    }
    ...
    connectedCallback() {
        ...
        this.slots.addEventListener('slotchange',()=>{
            this.elements  = this.querySelectorAll('wave-checkbox');
            this.value = this.defaultvalue;
            this.elements.forEach(el=>{
...
if(!customElements.get('wave-checkbox-group')){
    customElements.define('wave-checkbox-group', WaveCheckboxGroup);
}
