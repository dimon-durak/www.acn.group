...
import message from './wave-message.js';
...
class WaveColorPane extends HTMLElement {
...
customElements.define('wave-color-pane', WaveColorPane);

export default class WaveColorPicker extends HTMLElement {
    ...
    constructor() {
        ...
        <wave-popover id="popover" ${this.dir? "dir='"+this.dir+"'" : ""}>
            <wave-button class="color-btn" id="color-btn" ${this.disabled? "disabled" : ""}></wave-button>
            <wave-popcon id="popcon">
    ...
    connectedCallback() {
        ...
        this.colorBtn.addEventListener('click',()=>{
            if(!this.colorPane){
                this.colorPane = new WaveColorPane();
...
if (!customElements.get('wave-color-picker')) {
    customElements.define('wave-color-picker', WaveColorPicker);
}
