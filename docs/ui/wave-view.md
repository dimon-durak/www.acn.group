...
<wave-view class="dragbox" draggable dragaxis="X">dragaxis="X"</wave-view>

<wave-view class="dragbox" draggable dragaxis="Y">dragaxis="Y"</wave-view>

<wave-view class="dragbox" draggable>press shift</wave-view>
...
<wave-view resizable class="resizebox"></wave-view>
</div>
...
<div style="height:500px">
<wave-view resizable draggable class="resizebox" onresize="this.textContent=event.detail.width+','+event.detail.height"></wave-view>
</div>
